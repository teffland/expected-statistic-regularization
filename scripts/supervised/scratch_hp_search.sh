export wandb_tag="Scratch Supervsed HP search"
export wandb_note="Small LR grid search"
export treebank=$1
export log_name=$2
export config_path=config/supervised_scratch.jsonnet
...
export patience=10
declare -a lrs=( 0.00007 0.00002 0.000007 0.000002 )
for lr in "${lrs[@]}"
do
  export wandb_name="${treebank}_scratch_sup_lr-${lr}_ne-100"
