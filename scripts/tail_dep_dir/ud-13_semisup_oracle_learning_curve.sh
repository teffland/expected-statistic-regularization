export wandb_tag="UD-13 Semisup Oracle Learning Curve"
export wandb_note="Train semi-supervised. Use the oracle stats."
export treebank=$1
export log_name=$2
...
do
  ...
  do
    ...
    export wandb_name="${treebank}_ud-13_oracle_stat-trd_S${size}_R${seed}"
    run_train
    eval_dev
    eval_test
    sync_results
