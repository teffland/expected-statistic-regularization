...
export wandb_note="Train semi-supervised from scratch. Use the universal zero-only constraints."
export treebank=$1
export log_name=$2
...
do
  ...
  do
    ...
    export wandb_name="${treebank}_scratch_universal-arc_S${size}_R${seed}"
    run_train
    eval_dev
    eval_test
    sync_results
