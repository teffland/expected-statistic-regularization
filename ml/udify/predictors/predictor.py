...
@Predictor.register("udify_predictor", exist_ok=True)
class UdifyPredictor(Predictor):
    ...
    def predict(self, sentence: str, **metadata) -> JsonDict:
        return self.predict_json(dict(sentence=sentence, **metadata))
    ...
    def _predict_unknown(self, instance: Instance):
        ...
        def replace_tokens(instance: Instance, namespace: str, token: str):
            ...
            instance.fields[namespace].labels = [
                label if label in self._model.vocab._token_to_index[namespace] else token
    ...
    def _json_to_instance(self, json_dict: JsonDict) -> Instance:
        ...
        return self._dataset_reader.text_to_instance(tokens, metadata=json_dict)
