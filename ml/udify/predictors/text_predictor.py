...
from ml.udify.dataset_readers.universal_dependencies import UniversalDependenciesRawDatasetReader
...
class UdifyTextPredictor(Predictor):
    ...
    def __init__(self, model: Model, dataset_reader: DatasetReader, output_conllu: bool = False) -> None:
