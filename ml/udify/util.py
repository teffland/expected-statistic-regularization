...
# from ml.udify.dataset_readers.evaluate_2019_task2 import read_conllu, input_pairs, manipulate_data

from ml.udify.dataset_readers.conll18_ud_eval import evaluate, load_conllu_file, UDError
...
def predict_model_with_archive(
    predictor: str, params: Params, archive: str, input_file: str, output_file: str, batch_size: int = 1
):
    ...
    manager = _PredictManager(
        predictor, input_file, output_file, batch_size, print_to_console=False, has_dataset_reader=True
    )
    manager.run()
...
# def predict_model(
#     predictor: str, params: Params, archive_dir: str, input_file: str, output_file: str, batch_size: int = 1
# ):
#     """
...
#         predictor, params, archive, gold_file, pred_file, output_file, segment_file, batch_size
#     )
