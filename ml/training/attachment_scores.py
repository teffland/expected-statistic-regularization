...
class AttachmentScores(Metric):
    ...
    def __call__(  # type: ignore
        ...
        print(f"correct_indices = {correct_indices}")
        print(f"unlabeled_exact_match = {unlabeled_exact_match}")
        print(f"correct_labels = {correct_labels}")
        print(f"correct_labels_and_indices = {correct_labels_and_indices}")
        print(f"labeled_exact_match = {labeled_exact_match}")
